...
public class MenuPrincipal extends JFrame {
    ...
    // Paneles para el encabezado
    private JPanel panelTituloContenido;
    ...
    public MenuPrincipal() {
        ...
        // 1. Crear el Panel Superior Completo (Contiene Cerrar + Títulos)
        JPanel panelSuperiorCompleto = new JPanel(new BorderLayout());
        panelSuperiorCompleto.setBackground(COLOR_FONDO);
        
        // Crear los sub-paneles
        crearPanelCerrar(); // Crea 'panelCerrar'
        crearPanelTitulo(); // Crea 'panelTituloContenido' con los textos nuevos
        
        // Agregarlos al contenedor superior para que ambos se vean
        panelSuperiorCompleto.add(panelCerrar, BorderLayout.NORTH);
        panelSuperiorCompleto.add(panelTituloContenido, BorderLayout.CENTER);
        
        // Agregar el contenedor superior a la ventana
        add(panelSuperiorCompleto, BorderLayout.NORTH);
        
        // 2. Panel central con tarjetas
        ...
        // 3. Panel inferior con botón salir
    ...
    private void crearPanelTitulo() {
        panelTituloContenido = new JPanel();
        panelTituloContenido.setLayout(new BoxLayout(panelTituloContenido, BoxLayout.Y_AXIS));
        panelTituloContenido.setBackground(COLOR_FONDO);
        panelTituloContenido.setBorder(BorderFactory.createEmptyBorder(10, 40, 20, 40));
        
        // Texto 1: Institución (Pequeño, arriba)
        JLabel lblTec = new JLabel("TECNOLOGICO SUPERIOR DE TACAMBARO");
        lblTec.setFont(new Font("Segoe UI", Font.BOLD, 14));
        lblTec.setForeground(COLOR_TEXTO_SECUNDARIO);
        lblTec.setAlignmentX(Component.CENTER_ALIGNMENT);
        
        // Texto 2: Título del Proyecto (Grande)
        JLabel lblProyecto = new JLabel("PROYECTO SIMULACION");
        lblProyecto.setFont(new Font("Segoe UI", Font.BOLD, 28)); // Fuente más grande
        ...
        // Agregar en orden vertical
        panelTituloContenido.add(lblTec);
        panelTituloContenido.add(Box.createRigidArea(new Dimension(0, 5)));
        panelTituloContenido.add(lblProyecto);
        panelTituloContenido.add(Box.createRigidArea(new Dimension(0, 5)));
        panelTituloContenido.add(Box.createRigidArea(new Dimension(0, 20)));
        panelTituloContenido.add(separador);
    }
    
    private void crearPanelCerrar() {
        ...
        panelCerrar = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        panelCerrar.setBackground(COLOR_FONDO);
        panelCerrar.setBorder(BorderFactory.createEmptyBorder(5, 10, 0, 10));
    ...
    private void mostrarInformacion() {
        ...
        JOptionPane.showMessageDialog(this, scrollPane, "Información del Proyecto", JOptionPane.INFORMATION_MESSAGE);
    }
